<!-- ==========================================================================
     ...
     ========================================================================== -->
<section class="view" data-view="finance" hidden data-perm="owner">
  <div class="page-head">
    <div>
    ...
    <div class="head-actions">
      ...
      <button type="button" class="btn primary" onclick="window.openCreateInvoiceInBudget()" data-view="budget" title="Create invoice via Production Budget">
